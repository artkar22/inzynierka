...
public abstract class AbstractLayer implements Layer {
    ...
    public void sendEmptyMessage(Exchange exchange, EmptyMessage message) {
        if (lowerLayer != null)
            ...
            LOGGER.log(Level.SEVERE, "No lower layer found to send empty message {0} for exchange {1}", new Object[]{message, exchange});
    }
    ...
    public void receiveEmptyMessage(Exchange exchange, EmptyMessage message) {
        if (upperLayer != null)
            ...
            LOGGER.log(Level.SEVERE, "No upper layer found to receive empty message {0} for exchange {1}", new Object[]{message, exchange});
    }
